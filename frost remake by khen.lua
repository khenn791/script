...
-- // Crosshair Handler \\ --
local Cursor = loadstring(game:HttpGet('https://raw.githubusercontent.com/khen791/script-khen/refs/heads/main/bG7mehvN.txt', true))() do
                ...
                if Configurations.Visuals.Hit_Detection.Enabled then
                    ...
                    if Target then
                        if Configurations.Visuals.Hit_Detection.Notify then
                            Menu.Notify('khen<font color="#'..tostring(MainColor:ToHex())..'">.cc</font> | '..tostring(HitPart)..' | Target : '..Target.DisplayName,1.5)                            
                        end
...
TextButton.MouseButton1Down:Connect(toggleUI)
...
local function MenuNameUpdate()
    while task.wait() do
        ...
        for i = 1, #Name do
            ...
            Menu:SetTitle(PlaceHolder .. '<font color="#' .. tostring(Menu.Accent:ToHex()) .. '">.cc</font> | GUI')
            task.wait(0.25)
        end
    end
end

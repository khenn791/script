...
local Settings = {
    ...
    MinSize = Vector2.new(375, 260),
    MaxSize = Vector2.new(375, 260)
}
...
function SendNotification(text)
    Notification:Notify(
        ...
        {OutlineColor = Color3.fromRGB(255, 20, 147),Time = 3, Type = "image"},
...
Menu.Watermark()
Menu.Watermark:Update('khen<font color="#' .. tostring(Menu.Accent:ToHex()) .. '">.cc</font>') -- please fix this and we can add a variable for a color.

  --\\ Setting Stuff Function
  Menu.Watermark:SetVisible(false)
...
Menu.Slider("Main", "Cframe Desync", "Z", 5, 100, 0, "", 1, function(slider)
...
Menu.ComboBox("Main", "Visuals", "Material", "Pavement", {"Brick", "Sand", "Ice", "Grass", "Pavement"}, function(x)
 ...
 for i = 1, 3 do
    task.wait(0.5)
    Menu.Notify("khen.cc Has Loaded Successfully", 5)
end
